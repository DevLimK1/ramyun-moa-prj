...
@WebServlet("/admin/board/recipe/management")
public class ManagementController2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			list = service.getReviewAdminList(startDate, endDate, field, searchName, page);
			count = service.getReviewAdminCount(startDate, endDate, field, searchName);
		...
		container.render("admin.board.recipe.management", req, resp);
