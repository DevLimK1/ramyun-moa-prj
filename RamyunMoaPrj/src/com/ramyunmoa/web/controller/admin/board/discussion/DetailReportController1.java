...
@WebServlet("/admin/board/discussion/report-detail")
public class DetailReportController1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		container.render("admin.board.discussion.report-detail", req, resp);
