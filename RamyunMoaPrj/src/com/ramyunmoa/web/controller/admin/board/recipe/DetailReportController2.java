...
@WebServlet("/admin/board/recipe/report-detail")
public class DetailReportController2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		container.render("admin.board.recipe.report-detail", req, resp);
