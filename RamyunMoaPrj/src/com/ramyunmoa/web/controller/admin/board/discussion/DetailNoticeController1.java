...
@WebServlet("/admin/board/discussion/notice-detail")
public class DetailNoticeController1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		container.render("admin.board.discussion.notice-detail", req, resp);
