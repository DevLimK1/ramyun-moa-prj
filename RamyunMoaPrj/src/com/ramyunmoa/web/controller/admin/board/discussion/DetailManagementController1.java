...
@WebServlet("/admin/board/discussion/management-detail")
public class DetailManagementController1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		container.render("admin.board.review.discussion-detail", req, resp);
