...
@WebServlet("/admin/board/review/management-detail")
public class DetailManagementController3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		container.render("admin.board.review.management-detail", req, resp);
