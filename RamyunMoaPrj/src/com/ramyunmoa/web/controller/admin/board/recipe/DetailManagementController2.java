...
@WebServlet("/admin/board/recipe/management-detail")
public class DetailManagementController2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		container.render("admin.board.recipe.management-detail", req, resp);
