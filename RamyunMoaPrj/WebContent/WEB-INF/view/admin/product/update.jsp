	...
	<form action="update" method="get">
		<div class="search">
			<div>
				...
				<input type="radio" name="m" value="gs25"><label>세븐일레븐</label>
				<input type="radio" name="m" value="세븐일레븐">
			</div>
			<div>
				...
				<c:forEach var="l" items="${list}">
					...
					<tr>
						<td rowspan="2" colspan="2">
							<input type="image" src="${l.img}" name="img" value="${l.img}">
						</td>
						...
						<td rowspan="4">
							...
							<input class="bold" type="submit" value="수정">
						</td>
					</tr>
					<tr>
						<td><input type="text" name="natrium" value="${l.natrium}"></td>
						<td><input type="text" name="carbohydrate" value="${l.carbohydrate}"></td>
					...
					<tr>
						...
						<td><input type="text" name="saturatedFat" value="${l.saturatedFat}"></td>
						<td><input type="text" name="cholesterol" value="${l.cholesterol}"></td>
						<td><input type="text" name="protein" value="${l.protein}"></td>
					</tr>
					<tr>
						<td colspan="2"><input class="name" type="text" name="name" value="${l.name}"></td>
						...
						<div class="sales">
							...
							<select name="quarter" value="${l.quarter}" id="">
								<option value="1">1분기</option>
								<option value="2">2분기</option>
								<option value="3">3분기</option>
								<option value="4">4분기</option>
							</select>
							<input type="text" name="amount" value="${l.amount}">
							</div>
						</td>
					</tr>
				</c:forEach>
	...
	<div class="pager">
		<c:choose>
			<c:when test="${startNum>1}">
				<a href="update?m=${param.m}&p=${startNum-5}&s=${param.s}"><i class="fas fa-arrow-alt-circle-left fa-2x"></i>
				</a>
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			<c:when test="${startNum+4<lastNum}">
				<a href="update?m=${param.m}&p=${startNum+5}&s=${param.s}"><i class="fas fa-arrow-alt-circle-right fa-2x"></i>
				</a>
			</c:when>
			<c:otherwise>
