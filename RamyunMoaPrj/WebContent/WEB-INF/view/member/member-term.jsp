...
<main>
	<section class="terms-section">
		<h1 class="d-none">서비스 이용약관</h1>
		<form action="regist" name="form" method="post">
			<table class="terms-content">
				<tr>
					<td>서비스 이용약관</td>
				</tr>
				<tr>
...
제1조 (목적)
본 약관은 라면모아(이하 "회사"라 합니다)가 제공하는 라면모아 및 라면모아 관련 제반 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
본 약관은 2019년 06월 20일부터 적용합니다.
   </textarea></td>
				</tr>
				<tr>
					<td><input type="checkbox" name="req">내용을
						확인하였으며,동의합니다.</td>
				</tr>
				<tr>
					<td><input type="button" class="btn-style" value="다음"
						onclick="admit()"></td>
				</tr>
			</table>
		</form>
